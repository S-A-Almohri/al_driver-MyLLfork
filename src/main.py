            ...
            if not restart_controller.CLU_SELECTION:
                ...
                if config.DO_DOPT:
                    n_dopt_sel = gen_selections.gen_subset_dopt(
                            ...
                            job_executable     = config.CHIMES_LSQ,
                            job_nodes          = str(config.DOPT_DESC_NODES),
                            job_ppn            = str(config.DOPT_DESC_PPN),
                            job_walltime       = str(config.DOPT_DESC_TIME),
                            job_queue          = config.DOPT_DESC_QUEUE,
                            job_account        = config.HPC_ACCOUNT,
                            job_system         = config.HPC_SYSTEM,
                            job_email          = config.HPC_EMAIL,
                            job_modules        = config.DOPT_DESC_MODULES,
